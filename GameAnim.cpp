...
GameAnim::GameAnim(sf::Image &img,int nbrFrame,int nbrLigne,float time=0.f,float velx=0,float vely=0,float height=0, float width=0,float offsetColX=0,float offsetColY=0,bool col=false):
